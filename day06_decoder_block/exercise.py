"""Day 06 exercise: Pre-Norm Transformer Decoder Block."""
...
class DecoderBlock(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        # TODO: create norm1, attn, norm2, and ffn
        raise NotImplementedError("Implement DecoderBlock.__init__")
    ...
    def forward(
        ...
        # return x, attn
        raise NotImplementedError("Implement DecoderBlock.forward")
